--[[ unimpaired provides sensible keybinds
https://github.com/tummetott/unimpaired.nvim

general pattern: [=previous ]=next y=toggle

* a/A: arglist
* b/B: buffer
* l/L: loclist; <C-l>: stack of loclist
* q/Q: quickfix list; <C-q>: stack
* t/T: tag; <C-t>: stack
* f: file in directory
* <space>: blank line
* e: exchange line/section with above/below

options ([=off ]=on y=toggle):
* oc: cursorline
* od: diff
* oh: hlsearch
* oi: ignorecase
* ol: show invisible chars
* on: linenumber
* or: relative numbers
* os: spell check
* ob: set background to light
* ot: colorcolumn
* ou: cursorcolumn
* ov: virtualedit
* ow: linewrapping
