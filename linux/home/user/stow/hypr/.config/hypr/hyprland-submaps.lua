...
hl.define_submap("system", function()
    ...
    hl.bind("H", hl.dsp.exec_cmd("sudo /usr/bin/systemctl hibernate"))
    hl.bind("P", hl.dsp.exec_cmd("sudo /usr/bin/systemctl suspend"))
    hl.bind("R", hl.dsp.exec_cmd("sudo /usr/bin/systemctl reboot"))
    hl.bind("F", hl.dsp.exec_cmd("sudo /usr/bin/systemctl poweroff"))
